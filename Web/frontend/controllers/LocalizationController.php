...
use frontend\models\LocalizationSearch;
...
class LocalizationController extends Controller
{
    ...
    /**
     * Lists all Localization models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new LocalizationSearch();
    ...
    /**
     * Displays a single Localization model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Deletes an existing Localization model.
    ...
    {
        if (($model = Localization::findOne(['id' => $id])) !== null) {
            return $model;
        }
