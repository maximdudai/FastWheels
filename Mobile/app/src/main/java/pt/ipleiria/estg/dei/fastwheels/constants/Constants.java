...
public class Constants {
    ...
    public static final String API_CHAT_REQUEST = "http://54.229.223.123:8080/api/chat/request/";
    public static final String API_CHAT_UPDATE = "http://54.229.223.123:8080/api/chat/update/";
